...
class VideoService {
    ...
    async GetProfileVideo(user_name, videoId) {
        try {
            ...
            const query = `SELECT video_name, full_name, video_id, video_description 
                      from ${config_1.default.tbUser} 
                      inner join ${config_1.default.tbVideo} on ${config_1.default.tbUser}.user_id = ${config_1.default.tbVideo}.author_video 
    ...
    async updateVideo(videoId, reqBody) {
        try {
            ...
            const query = `update ${config_1.default.tbVideo} 
